...
public class TableConfig implements Configurable {
     ...
     */
    public TableConfig(String colour, double friction,
                       SizeConfig sizeConf, JSONArray pocketsJSON) {
        this.init(colour, friction, sizeConf, pocketsJSON);
    }

    private void init(String colour, double friction, SizeConfig sizeConf, JSONArray pocketsJSON) {
    ...
    public Configurable parseJSON(Object obj) {
        ...
        JSONArray pockets = (JSONArray) json.get("pockets");
    ...
    public JSONArray getPocketsJSON() {return this.pocketsJSON;}
}
